...
\begin{frame}
    ...
    (How to prove?)
    \nullspace
    \textbf{Remark:} This theorem is more practical than the definition of basis when proving some set is a basis of some vector space. It helps one decompose the proof into two parts: 1. prove linear independence (uniqueness of Eq.\ref{eq:basis}) 2. prove the span is large enough (existence of Eq.\ref{eq:basis}). 
\end{frame}
